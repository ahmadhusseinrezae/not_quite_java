...
%class_BBS = type {
     %vfTableStructBBS*  ; procs_pointer
    ,%array_i32*  ; number
    ,i32  ; size
}

%vfTableStructBBS = type {
...
@vtableGVarBBS = global %vfTableStructBBS  {
    i32(%class_BBS*, i32)* @Start,
    i32(%class_BBS*)* @Sort,
    i32(%class_BBS*)* @Print,
    i32(%class_BBS*, i32)* @Init
...
init:
    ...
    %t = load i32, i32* %sz1
    %vtableAddr = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 0
    %vtablePointer = load %vfTableStructBBS*, %vfTableStructBBS** %vtableAddr
    %procAddr = getelementptr %vfTableStructBBS, %vfTableStructBBS* %vtablePointer, i32 0, i32 3
    %procPointer = load i32(%class_BBS*, i32)*, i32(%class_BBS*, i32)** %procAddr
    %Init_result = call i32 %procPointer(%class_BBS* %this, i32 %t)
    store i32 %Init_result, i32* %aux01
    ;18 end statement: aux01 = this.Init(sz);
    ;19 start statement : aux01 = this.Print();
    %vtableAddr1 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 0
    %vtablePointer1 = load %vfTableStructBBS*, %vfTableStructBBS** %vtableAddr1
    %procAddr1 = getelementptr %vfTableStructBBS, %vfTableStructBBS* %vtablePointer1, i32 0, i32 2
    %procPointer1 = load i32(%class_BBS*)*, i32(%class_BBS*)** %procAddr1
    %Print_result = call i32 %procPointer1(%class_BBS* %this)
    ...
    %vtableAddr2 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 0
    %vtablePointer2 = load %vfTableStructBBS*, %vfTableStructBBS** %vtableAddr2
    %procAddr2 = getelementptr %vfTableStructBBS, %vfTableStructBBS* %vtablePointer2, i32 0, i32 1
    %procPointer2 = load i32(%class_BBS*)*, i32(%class_BBS*)** %procAddr2
    %Sort_result = call i32 %procPointer2(%class_BBS* %this)
    store i32 %Sort_result, i32* %aux01
    ;21 end statement: aux01 = this.Sort();
    ;22 start statement : aux01 = this.Print();
    %vtableAddr3 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 0
    %vtablePointer3 = load %vfTableStructBBS*, %vfTableStructBBS** %vtableAddr3
    %procAddr3 = getelementptr %vfTableStructBBS, %vfTableStructBBS* %vtablePointer3, i32 0, i32 2
    %procPointer3 = load i32(%class_BBS*)*, i32(%class_BBS*)** %procAddr3
    %Print_result1 = call i32 %procPointer3(%class_BBS* %this)
...
init:
    ...
    %iAddr = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 2
...
loopBodyStart1:
    ...
    %iAddr1 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t7 = load %array_i32*, %array_i32** %iAddr1
...
indexInRange:
    ...
    %iAddr2 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t10 = load %array_i32*, %array_i32** %iAddr2
...
ifTrue:
    ...
    %iAddr3 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t16 = load %array_i32*, %array_i32** %iAddr3
...
indexInRange2:
    ...
    %iAddr4 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t19 = load %array_i32*, %array_i32** %iAddr4
...
indexInRange3:
    ...
    %iAddr5 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t21 = load %array_i32*, %array_i32** %iAddr5
...
indexInRange4:
    ...
    %iAddr6 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
    %t24 = load %array_i32*, %array_i32** %iAddr6
...
indexInRange4:
    ...
    %iAddr7 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
...
indexInRange5:
    ...
    %iAddr8 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
...
indexInRange6:
    ...
    %iAddr9 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
...
indexInRange7:
    ...
    %iAddr10 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
...
indexInRange8:
    ...
    %iAddr11 = getelementptr %class_BBS, %class_BBS* %this, i32 0, i32 1
...
define %class_BBS* @newClassBBS() {
init:
    %sizeOfStruct = add i32 0, 24
    %mallocRes = call i8* @malloc(i32 %sizeOfStruct)
    %newObject = bitcast i8* %mallocRes to %class_BBS*
    %iAddr = getelementptr %class_BBS, %class_BBS* %newObject, i32 0, i32 0
    store %vfTableStructBBS* @vtableGVarBBS, %vfTableStructBBS** %iAddr
    ret %class_BBS* %newObject
...
init:
    ...
    %NewObjectBBS = call %class_BBS* @newClassBBS()
    %vtableAddr = getelementptr %class_BBS, %class_BBS* %NewObjectBBS, i32 0, i32 0
    %vtablePointer = load %vfTableStructBBS*, %vfTableStructBBS** %vtableAddr
    %procAddr = getelementptr %vfTableStructBBS, %vfTableStructBBS* %vtablePointer, i32 0, i32 0
    %procPointer = load i32(%class_BBS*, i32)*, i32(%class_BBS*, i32)** %procAddr
    %Start_result = call i32 %procPointer(%class_BBS* %NewObjectBBS, i32 10)
