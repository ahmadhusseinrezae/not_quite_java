...
init:
    ...
    ;15 start statement : return this.y;
...
init:
    ...
    %y_result = call i32 %procPointer(%class_B* %t)
    store i32 %y_result, i32* %x
    ;5 end statement: x = a.y();
