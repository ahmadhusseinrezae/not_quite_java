...
init:
    ...
    %procAddr1 = getelementptr %vfTableStructB, %vfTableStructB* %vtablePointer1, i32 0, i32 2
    ...
    ;11 start statement : printInt(a.show());
    ...
    %procPointer2 = load i32(%class_A*)*, i32(%class_A*)** %procAddr2
    %show_result = call i32 %procPointer2(%class_A* %castValue)
    call void @print(i32 %show_result)
    ;11 end statement: printInt(a.show());
