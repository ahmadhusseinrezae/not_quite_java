...
init:
    ...
    %newArray3 = call %"array_%\22array_%array_i32*\22*"* @newArray2(i32 2)
...
indexInRange2:
    ...
    %newArray5 = call %array_i32* @newArray(i32 2)
...
define %"array_%\22array_%array_i32*\22*"* @newArray2(i32 %size) {
init:
    %sizeLessThanZero = icmp slt i32 %size, 0
    br i1 %sizeLessThanZero, label %negativeSize, label %goodSize
