...
@vtableGVarC = global %vfTableStructC  {
...
init:
    ...
    %iAddr = getelementptr %class_A, %class_A* %this, i32 0, i32 2
    store i32 10, i32* %iAddr
    ;14 end statement: this.x = 10;
    ;15 start statement : return this.x;
    %iAddr1 = getelementptr %class_A, %class_A* %this, i32 0, i32 2
    %t = load i32, i32* %iAddr1
    ret i32 %t
...
define %class_C* @newClassC() {
init:
    %sizeOfStruct = add i32 0, 8
    %mallocRes = call i8* @malloc(i32 %sizeOfStruct)
    %newObject = bitcast i8* %mallocRes to %class_C*
    %iAddr = getelementptr %class_C, %class_C* %newObject, i32 0, i32 0
    store %vfTableStructC* @vtableGVarC, %vfTableStructC** %iAddr
    ret %class_C* %newObject
