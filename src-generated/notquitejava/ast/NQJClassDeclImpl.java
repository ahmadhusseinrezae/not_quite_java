...
class NQJClassDeclImpl implements NQJClassDecl{
    NQJClassDeclImpl(String name, NQJExtended extended, NQJVarDeclList fields, NQJFunctionDeclList methods) {
        if (name == null)
    ...
    public NQJElement set(int i, NQJElement newElem) {
        ...
        switch (i) {
            ...
            case 1: oldElem = fields; setFields((NQJVarDeclList) newElem); return oldElem;
            case 2: oldElem = methods; setMethods((NQJFunctionDeclList) newElem); return oldElem;
            default: throw new IllegalArgumentException("Index out of range: " + i);
        }
    }
    ...
    @Override public NQJClassDecl copy() {
        NQJClassDecl result = new NQJClassDeclImpl(name, (NQJExtended) this.extended.copy(), (NQJVarDeclList) this.fields.copy(), (NQJFunctionDeclList) this.methods.copy());
...
result.setDirectSuperClass(getDirectSuperClass());
    ...
    @Override public String toString() {
        return "ClassDecl(" + name + ", " +extended + ", " +fields + ", " +methods+")";
    }
