...
public class NQJ {
    public static NQJProgram Program(NQJClassDeclList classDecls, NQJFunctionDeclList functionDecls) {
        return new NQJProgramImpl(classDecls, functionDecls);
    }
    ...
    public static NQJClassDecl ClassDecl(String name, NQJExtended extended, NQJVarDeclList fields, NQJFunctionDeclList methods) {
        return new NQJClassDeclImpl(name, extended, fields, methods);
    }
    ...
    public static NQJTypeArray TypeArray(NQJType componentType) {
        return new NQJTypeArrayImpl(componentType);
    }
