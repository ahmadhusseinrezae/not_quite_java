...
class NQJProgramImpl implements NQJProgram{
    NQJProgramImpl(NQJClassDeclList classDecls, NQJFunctionDeclList functionDecls) {
        if (classDecls == null)
    ...
    @Override public NQJProgram copy() {
        NQJProgram result = new NQJProgramImpl((NQJClassDeclList) this.classDecls.copy(), (NQJFunctionDeclList) this.functionDecls.copy());
result.setSourcePosition(getSourcePosition());
    ...
    @Override public String toString() {
        return "Program(" + classDecls + ", " +functionDecls+")";
    }
